...
export default class Fetch {
    ...
    post(path, data = {}, options = {}) {
        return this.request(path, 'POST', { ...options, body: JSON.stringify(data) });
    }
    ...
    put(path, data = {}, options = {}) {
        return this.request(path, 'PUT', { ...options, body: JSON.stringify(data) });
    }
    ...
    delete(path, data = {}, options = {}) {
        return this.request(path, 'DELETE', { ...options, body: JSON.stringify(data) });
    }
    ...
    patch(path, data = {}, options = {}) {
        return this.request(path, 'PATCH', { ...options, body: JSON.stringify(data) });
    }
